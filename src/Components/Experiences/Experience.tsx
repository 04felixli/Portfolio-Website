...
import { ExperienceObject } from "../../Constants/ExperienceObjects";
...
const Experience = ({ experience }: Props) => {
    ...
    return (
        <div className="text-color flex flex-row">
            <button className="w-80 h-80 rounded-full border border-color6 border-4 overflow-hidden shadow-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:shadow-lg" onClick={() => openCompanyLink(experience.companyWebsiteLink)}>
