...
const Home = () => {
    ...
    return (
        <div className="text-color flex flex-row">
            ...
            <a href={AboutMe.linkedIn} target="_blank" className="w-96 h-96 rounded-full border border-color6 border-4 overflow-hidden relative shadow-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:shadow-lg">
