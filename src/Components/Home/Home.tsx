    ...
    return (
        <div className="text-color flex flex-row items-center">
            <section className="w-full tablet:w-6/12 flex flex-col">
                ...
                <a href="Resume.pdf" target="_blank" rel="noreferrer" className=" w-fit px-4 py-1 shadow-md rounded-full mt-5 bg-color6 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:shadow-lg text-center">Resume</a>
            </section>
